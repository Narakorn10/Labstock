...
export default function QRScanner({ onScan, onClose }: QRScannerProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black z-[100] flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-lg aspect-square bg-gray-900 rounded-3xl overflow-hidden relative shadow-2xl border-2 border-white/20">
        <div id={scannerId} className="w-full h-full" />
        
        {/* Scanning Overlay (Visual only) */}
        {!error && isScannerStarted && (
